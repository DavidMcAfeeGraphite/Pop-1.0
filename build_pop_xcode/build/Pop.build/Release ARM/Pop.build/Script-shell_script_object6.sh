...
s3e_plink -o "/Users/David/Downloads/Pop/build_pop_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/Pop.s3e" --arch=armv6 --compiler=clang -u --usemap="/Users/David/Downloads/Pop/build_pop_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/Pop.map" "${TARGET_BUILD_DIR}/${EXECUTABLE_NAME}"
