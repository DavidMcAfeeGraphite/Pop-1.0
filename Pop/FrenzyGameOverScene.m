...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([[touchedNode name] isEqualToString:@"restart"]||[[touchedNode name] isEqualToString:@"restar"]) {
        ...
        if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
        {
            ...
            [tweetSheet setInitialText: [NSString stringWithFormat:@"Can you beat my Pop high score in frenzy mode? Get Pop for iOS. I got a score of %1d. https://itunes.apple.com/us/app/pop/id950936583?mt=8",(long)highScore]] ;
