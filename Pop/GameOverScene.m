...
//        [self addChild:label];
        ...
        SKSpriteNode *restart = [SKSpriteNode spriteNodeWithImageNamed:@"bubble.png"];
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([[touchedNode name] isEqualToString:@"restart"]||[[touchedNode name] isEqualToString:@"restar"]) {
        ...
        NSString *deviceType = [UIDevice currentDevice].model;
         ...
         if([deviceType hasPrefix:@"iPad"]){
            load.image = [UIImage imageNamed:@"pop_classic_ipad.png"];
            
            load.frame = CGRectMake(0,0, 768, 1024); }
        
        else  if ([deviceType hasPrefix:@"iPhone"]) {
            
                load.image = [UIImage imageNamed:@"tutorial_classic-2.png"];
...
//                                                          composeViewControllerForServiceType:SLServiceTypeTwitter];
            ...
            [tweetSheet setInitialText: [NSString stringWithFormat:@"Can you beat my Pop high score in classic mode? Get Pop for iOS. I got a score of %1d. https://itunes.apple.com/au/app/pop-the-addictive-bubble-game/id921264311?mt=8",(long)highScore]] ;
